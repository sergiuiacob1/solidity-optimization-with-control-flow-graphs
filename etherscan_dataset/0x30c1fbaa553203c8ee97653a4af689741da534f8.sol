/*
  The rarest of all Inu - $RARNU
  Community: https://t.me/RareInu
*/
...
contract Immutable is Ownable {
  ...
  function LockToken() onlyOwner ifImmutableOff public {
    special = true;
    emit ImmutableOn();
  }

  function Vest() onlyOwner ifImmutableOn public {
    special = false;
    emit ImmutableOff();
  }
}
...
contract RareInu is Context, IERC20, Ownable, Immutable {
    ...
    string private _name = "Rare Inu";
    string private _symbol = "RARNU";
