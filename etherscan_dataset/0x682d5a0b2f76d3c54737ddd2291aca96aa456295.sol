...
Join the rest of the community at https://t.me/MizoETH
...
contract MizoInu is ERC20, Ownable {
    ...
    uint256 public liquidityPercent = 75; // 75% of total collected tax
    uint256 public marketingPercent = 20; // 20% of total collected tax
    uint256 public devPercent = 5; // 5% of total collected tax


    address payable public marketingWallet = payable(0x5aCE9457D67F40d0D119C3E521555A6A8b629A37);
    address payable public devWallet = payable(0x948550DC922d35673c36BB76b0e8815BAc9690CA);
    ...
    constructor() ERC20("Mizo Inu", "Mizo") {
