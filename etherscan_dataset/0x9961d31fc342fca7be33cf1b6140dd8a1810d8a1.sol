...
// File: contracts/erc721/contracts/IERC721A.sol
...
// File: contracts/erc721/contracts/ERC721A.sol
...
contract PAT is ERC721A, Ownable {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if(publicSale) {
            ...
            if(supply <= 111) {
                require(verifyUser(msg.sender), "You need to be whitelisted for this phase!");
                cost = cost1;
        ...
        if (msg.sender != owner()) {
            require(walletOfOwner(_to).length + _mintAmount <= totalWallet, "You have reached minting limit!");
