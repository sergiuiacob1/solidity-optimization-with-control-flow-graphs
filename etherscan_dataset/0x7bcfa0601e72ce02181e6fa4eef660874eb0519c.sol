...
Free....free...free.....free....freee....Ape coins

TG - https://t.me/FreeApeCoinPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable APE = address(0x4d224452801ACEd8B2F0aebE155379bb5D594381); //UNI
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Claim Ape shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract FreeApeCoin is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Free Ape Coin";
    ...
    address payable public marketingWallet = payable(0xe9E229238F794C472ccF23D88ca2E07eaE70e785);
