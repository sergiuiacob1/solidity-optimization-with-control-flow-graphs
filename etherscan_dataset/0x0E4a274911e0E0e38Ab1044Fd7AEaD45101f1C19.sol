...
/**
PYTHAGORASSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS

Welcome to Pythagoras Token (PYTHAGORAS) !

TOKENOMICS:

Supply: 345,345,345,345 tokens

Buy / Sell Tax
10% marketing
2% LP

no max wallet, max tx

CA Renounced
LP Locked

Telegram : @pythagorastoken

TOKENNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
*/
...
contract pythagoras is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 345_345_345_345 * 10**_decimals;
