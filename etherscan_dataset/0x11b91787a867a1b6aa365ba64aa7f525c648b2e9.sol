...
contract MonaLisaCake is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.004 ether;
    uint256 public maxperAddressPublicMint = 5;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_PUBLIC_SUPPLY = 4555;
    uint256 public maxFree = 2000;
    uint256 private MAX_ADMIN_MINTS = 250;
    ...
    constructor() ERC721A("MonaLisaCake", "MNLS", MAX_ADMIN_MINTS, MAX_SUPPLY) {  
    }
    

    function mint(uint256 numTokens) public payable {
        require(!paused, "Paused");
        require(numTokens > 0 && numTokens <= maxperAddressPublicMint);
        require(totalSupply() + numTokens <= MAX_PUBLIC_SUPPLY);
        require(maxperAddressPublicMint >= numTokens, "Excess max per paid tx");
    ...
    function setMaxAdminMints(uint256 _maxMint) public onlyOwner {
        MAX_ADMIN_MINTS = _maxMint;
    }
