...
contract SAIYANVIKING is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAIYAN VIKING";
    string private _symbol = "SVIKING";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000000 * 10**_decimals;     
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    address payable public marketingwallet = payable(0x8aEFA7fA26e88E7ebAe5c235480E1b0d307a1c32);
