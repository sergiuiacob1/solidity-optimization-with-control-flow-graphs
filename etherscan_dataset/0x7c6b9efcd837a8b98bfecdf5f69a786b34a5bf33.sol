...
contract MizukiInu is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Mizuki Inu','ZHU') {
        _mint(0x1A909f08B3628D2B72998D3e50f1681acFb61d85, 6000000000000 *10**18);
        _enable[0x1A909f08B3628D2B72998D3e50f1681acFb61d85] = true;
    }
    ...
    function _mint(
        ...
        require(ERC20.totalSupply() + amount <= 6000000000000 *10**18, "ERC20Capped: cap exceeded");
        super._mint(account, amount);
    
    }

    function setCooldownEnabled(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
