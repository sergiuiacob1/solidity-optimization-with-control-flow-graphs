...
contract ST_Mintable_Burnable_Token is Ownable, IST20, TokenGenerator {
    ...
    constructor (string memory name, string memory symbol, uint256 decimals, uint256 supply, address payable feeReceiver) TokenGenerator(feeReceiver, "ST_Mintable_Burnable_Token") payable public {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        _totalSupply = supply;
