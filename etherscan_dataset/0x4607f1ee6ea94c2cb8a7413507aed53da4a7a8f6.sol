...
contract wareHero is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Ware Hero";
    ...
    uint256 public maxTxn = 30 * 1e6 * 1e9;
    ...
    address payable private _marketingAddress = payable(0xEB35b0830993d3e275BA71685AC5045547c8868a);
    address payable private deploymentWallet = payable(0x2E8dAb8B23a350854eAD52b5E4f61Df5359Aec07);
