...
ORSOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
...
2% max tx and max wallet at launch
4% max tx and max wallet after launch
...
contract orsoinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Orso Inu";
    string private constant _symbol = "$OSO";
