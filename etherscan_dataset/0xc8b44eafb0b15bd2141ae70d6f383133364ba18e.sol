...
contract TrippinApeTribeEth is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("TrippinApeTribeEth", "TRPE"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"auuuugggggaaaaa");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Sooooollddd out auuuuuggggaaaaa");
    require(mintEnabled, "Minting not live!");
