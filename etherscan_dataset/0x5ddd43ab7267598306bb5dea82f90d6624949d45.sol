...
contract KINA is ERC20, Ownable {
    ...
    uint256 private _buyKinaFee;
    
    uint256 public sellTotalFees;
    uint256 private _sellMarketingFee;
    uint256 private _sellLiquidityFee;
    uint256 private _sellKinaFee;
    ...
    constructor() ERC20("Kina Inu", "KINA") {
        ...
        uint256 buyKinaFee = 1; // Total Buy Fees: 4%

        uint256 sellMarketingFee = 4;
        uint256 sellLiquidityFee = 1;
        uint256 sellKinaFee = 7; // Total Sell Fees: 12%
        ...
        _buyKinaFee = buyKinaFee;
        buyTotalFees = _buyMarketingFee + _buyLiquidityFee + _buyKinaFee;
        
        _sellMarketingFee = sellMarketingFee;
        _sellLiquidityFee = sellLiquidityFee;
        _sellKinaFee = sellKinaFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee + _sellKinaFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                _tokensForDev += fees * _sellKinaFee / sellTotalFees;
            ...
            // on buy
                ...
                _tokensForDev += fees * _buyKinaFee / buyTotalFees;
