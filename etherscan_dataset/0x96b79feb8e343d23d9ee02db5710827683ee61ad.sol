...
/**
* @title PackagePortal - WrappedPort Token for Ethereum.
*
...
contract PortToken is ERC20, Ownable {
  ...
  constructor(address _lockProxyAddress) ERC20("PackagePortal", "PORT") {
  ...
  function updateLockProxy(address proxy) public onlyOwner {
      lockProxyAddress = proxy;
  }
