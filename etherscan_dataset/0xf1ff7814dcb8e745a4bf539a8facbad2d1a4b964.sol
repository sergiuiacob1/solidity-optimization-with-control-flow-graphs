...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF2646c7f69a1d5AD05731F6Da3615707901B864f];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmf46Ao3eFrDutZ1nJ1bwXbTe7R17ycoVnKs2UB6GwG1Jm/";
...
// File: contracts/EthBitBirdzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EthBitBirdzContract is RamppERC721A {
    constructor() RamppERC721A("ETH Bit Birdz", "EBB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sTbPpa1cNpGZfkz5fQLC/contract-metadata";
    }
}
