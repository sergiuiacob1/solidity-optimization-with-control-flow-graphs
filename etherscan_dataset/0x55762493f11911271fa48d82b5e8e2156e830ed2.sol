...
contract YAUTJAINU is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 150000 * (10**18);
    ...
    uint256 public earlySellTotalFee = 24;
    ...
    uint256 public liquidityPercent = 0; // 0% of total collected tax
    uint256 public marketingPercent = 50; // 50% of total collected tax
    uint256 public devPercent = 50; // 50% of total collected tax


    address payable public marketingWallet = payable(0xddC1D120DCb5017fCDFc97136FE450Cd5AdaF132);
    address payable public devWallet = payable(0xddC1D120DCb5017fCDFc97136FE450Cd5AdaF132);
    ...
    constructor() ERC20("Yautja Inu", "YAUTJA") {
   ...
   function updateSellTotalTax(uint256 _sellTotalFees) public onlyOwner {
        ...
        require(sellTotalFees <= 25, "Fee too high");
    }
