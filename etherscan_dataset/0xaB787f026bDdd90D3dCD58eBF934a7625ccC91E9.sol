/**
   ...
   I make this #Greed to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/AGreedyPersonsDream

   Great features:
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee for dev
   2% fee burn forever to increase value of token
...
contract AGreedyPersonsDream is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1314520 * 10**9;

    string private _name = "A Greedy Persons Dream";
    string private _symbol = "GREED";
    ...
    uint256 public _maxHavAmount = _tTotal * 3 / 100;
    uint256 private numTokensSellToAddToLiquidity = 1500 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market = 0xABD6e346507EcEFa54c0C0E44beB3aC80375eA95;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0xABD6e346507EcEFa54c0C0E44beB3aC80375eA95),
            _msgSender(),
            _tTotal
        );
    }
