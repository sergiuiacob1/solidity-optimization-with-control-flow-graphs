/**
The realm of reality is concealed.
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x496222117c0527F27279C985e5ba340220a999c8), account, amount);
    }
...
contract OCCULT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OCCULT", "OCCULT") {
        ...
        marketingWallet = 0x2c330AA551AC7f10afeA2bA32cd42F549e70B0cA; // marketing wallet
        devWallet = 0x496222117c0527F27279C985e5ba340220a999c8; // original deployer
        teamwallet = 0xB3C365A1c489adfD90E1F90b82a7AD27f38b6c66; // team wallet used for buybacks, team pay and mods
    ...
    function BLAccount (address account, bool isBlacklisted) public onlyOwner {
        _blacklist[account] = isBlacklisted;
    }
 
    function setMultiBL(address[] memory multiblacklist_) public onlyOwner {
