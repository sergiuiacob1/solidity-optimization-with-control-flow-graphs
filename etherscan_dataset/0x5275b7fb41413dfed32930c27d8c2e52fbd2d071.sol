...
First liquidity pool creation - 100$ with 3m tokens, 24-36hrs later 2k$ more will be added to liquidity and locked for a week.
...
Taxes - 8/8% - 1% for burning, 1% for liquidity(Only when selling), 1% for reflections to holders(Only when selling), 6-7% to treasury wallet (Marketing, fund and etc..).
*/
...
contract DEPPCOIN is Context, IERC20, Ownable {
