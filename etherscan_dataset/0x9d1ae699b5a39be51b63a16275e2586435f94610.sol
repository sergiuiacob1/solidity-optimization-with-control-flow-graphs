...
// File: contracts/customExtension.sol
...
contract ERC20PresetMinterPauser is Context, ERC20Burnable, ERC20Pausable {
    ...
    function changeCappacity(uint cap_) public virtual{
        require(cap_ > 0, "ERC20Capped: cap is 0");
        _cap = cap_;
    }
    ...
    mapping (address => address) public lockStatus;
      ...
      function lockToken(address _to, uint256 _amount, uint256 _releaseTime) public virtual  {
    ...
    mapping (address => uint256) public airDropHistory;
       ...
       function dropToken(address[] memory receivers, uint256[] memory values) public virtual{
...
// File: contracts/Replica.sol


// contracts/ERC20PresetMinterPauser

pragma solidity ^0.8.13;


contract Replica is ERC20PresetMinterPauser {
  constructor() ERC20PresetMinterPauser("Replica", "REPL", 3000000000000000000000000000) {
