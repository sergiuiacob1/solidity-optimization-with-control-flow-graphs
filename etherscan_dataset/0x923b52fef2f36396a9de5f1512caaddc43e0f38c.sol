...
contract Omen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Omen";
    ...
    uint256 public _maxWalletAmount = 150000 * 10**_decimals;
    ...
    address payable private _marketingAddress = payable(0x6156B29316E866C0916F5798146c47ba3e2648d7);
    address payable private deploymentWallet = payable(0x710E11468E2A40Cd59e03f1A556Fb3440D55f442);
