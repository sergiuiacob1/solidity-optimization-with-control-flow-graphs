...
contract CNC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coinnewcap";
    ...
    address payable private _marketingAddress = payable(0x2C2443352d565fE6172D552a0BdBc24ab93E7ebC);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 40000000 * 10**9);
