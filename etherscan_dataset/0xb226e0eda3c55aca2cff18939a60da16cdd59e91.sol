/* 
    ...
    I suggest a telegram group name for you to create: https://t.me/NewCommunityLunaETH

    Great features:
    1% buy fee and 2% sell fee auto add to the liquidity pool to locked forever when selling
    ...
    I will add 2.5 ETH and 99% of the total supply to the pool
    Can you make #cLuna 10000000X? 

    1,000,000,000,000 total supply
    15,000,000,000 tokens limitation for trade, which is 1.5% of the total supply 
    1% tokens for dev
*/
...
contract cLUNA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("New Community Luna", "cLUNA") { //ticker need same as constructor name
