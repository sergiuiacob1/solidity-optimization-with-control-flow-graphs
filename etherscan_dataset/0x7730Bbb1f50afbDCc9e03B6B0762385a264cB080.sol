/*
Woman strips on Cannes red carpet to PROTEST against sexual violence in Ukraine.
Let the world know about Russia's crimes
...
contract SRU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Stop Raping Us";//
    ...
    address payable private _developmentAddress = payable(0xf7730842b3f20054B25EAa5E489c73b5Ca48aE83);//
    address payable private _marketingAddress = payable(0xf7730842b3f20054B25EAa5E489c73b5Ca48aE83);//
