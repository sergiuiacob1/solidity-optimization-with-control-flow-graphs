...
contract EARCLove is ERC1155, IERC2981, Ownable {
    string public name = "69k Gold";
    string public symbol = "69k";
    ...
    function sendAirdrop(address[] calldata to) external onlyOwner {
