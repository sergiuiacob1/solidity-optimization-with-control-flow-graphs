...
contract HunterPredator is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Hunter Predator";
    ...
    address payable private _developmentAddress = payable(0x2892ac8645A0B87B6b63b22B9bD1d74698A6Ed26);
    address payable private _marketingAddress = payable(0xd107588b1237C0B3277B984a2754B4F348E275eb);
    ...
    function sendETHToFee(uint256 amount) private {
        _developmentAddress.transfer(amount.mul(30).div(100));
        _marketingAddress.transfer(amount.mul(70).div(100));
    }
