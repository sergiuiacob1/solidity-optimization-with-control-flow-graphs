...
Pretty Low Tax : 3% BUY / 3% SELL 

Renounced & locked 

Initial LP : 1.5 eth 

Max buy : 1.5% at launch 
Max Wallet : 3%
...
contract ElonGateCommunity is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 MAX_INT =
        115792089237316195423570985008687907853269984665640564039457584007913129639935;
    string private constant _name = "ElonGateCommunity";
    string private constant _symbol = "ElonGateCommunity";
    ...
    uint256 public _maxTxAmount = 15000000 * 10**9; // 1.5% MAX TX
