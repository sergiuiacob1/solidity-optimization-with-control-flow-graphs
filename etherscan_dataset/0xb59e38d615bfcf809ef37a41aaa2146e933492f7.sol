...
Lock Liq
Tax: 5% buy
first 30 min sell tax 15% then 5%
change sell tax and renounce
https://t.me/GurukoInu
*/
...
contract GurukoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Guruko Inu";
    string private constant _symbol = "GURUKO";
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount > 2000000 * 10**9 );
