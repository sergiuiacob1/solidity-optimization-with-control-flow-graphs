...
contract SHIBLUNA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SHIBLUNA", "SLUNA") {
        ...
        maxTransactionAmount = totalSupply * 100 / 10000; // 1.0% maxTransaction amount.
        ...
        marketingWallet = 0xDF308C4EDb9912f89ACd8c444CF62844AF4f9e70; // marketing wallet
        devWallet = 0xeC7eb24F65828f21EC00CC352fF3a2Ea0b10A092; // original deployer
        teamwallet = 0x478E93A1687eF43aa6b75fA0183BfE3379F6B37D; // team wallet used for buybacks, team pay and mods
