...
// File: contracts/BallinTraveler_LowGas.sol
...
contract TheBallinTraveler is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Ballin' Traveler", "TBT") {
    setHiddenMetadataUri("ipfs://QmSHQKVYfJjYmbUcvZBJd2bTTRak3e6jhcqLHKu6EMfaNF/hidden.json");
  }
